...
const privacyText = `
  abOS collects limited anonymous analytics to help improve stability and usage insights.
  ...
  abOS does not sell user data or share it with advertisers.
`;

const copyrightText = `
  Copyright & Takedown Requests

  abOS doesn't host any copyrighted content. Games and apps are loaded from their original sources or CDNs.
...
export class AboutApp extends BaseApp {
  ...
  open(opts = {}) {
    const win = os.window.create("about-yukios", "About abOS", "720px", "85vh", {
      ...
      <div class="abx">
        <div class="abx-shell">
          ...
          <div class="abx-grid">
            ...
            <div class="abx-panel">
              <div class="abx-panel-h">Support abOS</div>
              <div class="abx-panel-b">
                <div class="abx-sponsor">
                  ...
                  <div class="abx-sponsor-content">
                    ...
                    <div class="abx-sponsor-desc">Help keep abOS free and open source. Your support directly funds development.</div>
