  ...
  return `
    <div class="donation-overlay" id="donation-overlay">
      <div class="donation-popup">
        ...
        <div class="donation-title">Support abOS</div>
        <div class="donation-message">
          abOS is built and maintained by one person in their free time. It is 100% free with no locked features and no paid tiers, so this donation is purely optional.
          <br><br>
