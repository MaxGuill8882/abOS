export const appMap = {
  ...
  nightInTheWoods: {
    type: "game",
    url: "/static/games/html/nightwoods.html",
    icon: "/static/icons/night.webp",
  ...
  suicideGuy: {
    type: "game",
    url: "/static/games/html/suicideGuy.html",
    icon: "/static/icons/suicideguy.webp",
    title: "Suicide Guy"
  },
  ytlifeomg: {
    type: "game",
    url: "/static/games/html/ytlifeomg.html",
  ...
  baldiBalds: {
    type: "game",
    url: "/static/games/html/baldiBalds.html",
    icon: "/static/icons/baldiBalds.webp",
    title: "Baldi Balds The Universe"
  },
  baldisBasicsTeachingOnTwos: {
    type: "game",
    url: "/static/games/html/baldisBasicsTeachingOnTwos.html",
    icon: "/static/icons/baldisBasicsTeachingOnTwos.webp",
    title: "Baldi's Basics: Teaching On Twos"
  },
  playtimeHellBear5van: {
    type: "game",
    url: "/static/games/html/playtimeHellBear5van.html",
    icon: "/static/icons/playtimeHellBear5van.webp",
  ...
  three: {
    ...
    icon: "/static/icons/three.webp",
    title: "Three"
  },
  theMathIsLeaking: {
    type: "game",
    url: "/static/games/html/themathisleaking.html",
  ...
  terraria: {
    type: "game",
    url: "/static/games/html/terraria.html",
  ...
  brotatoAllPain: {
    type: "game",
    url: "/static/games/html/brotatoAllPain.html",
    icon: "/static/icons/brotato.webp",
    title: "Brotato All Pain No Gain + Abyssal Terrors"
  },
  geometryDash: {
    type: "game",
  ...
  cuphead: {
    type: "game",
    url: "/static/games/html/cuphead.html",
  ...
  fnafworld: {
    type: "game",
    url: "https://irv77.github.io/hd_fnaf/w/",
    icon: "/static/icons/fnafworld.webp",
    title: "Fnaf World"
  },
  game2048: {
    type: "game",
  ...
  happyRoom: {
    type: "game",
    url: "/static/games/html/happyRoom.html",
  ...
  myRustySubmarine: {
    ...
    icon: "/static/icons/myRustySubmarine.webp",
    title: "My Rusty Submarine"
  },
  upstream: {
    type: "game",
    url: "/static/games/html/upstream.html",
    icon: "/static/icons/upstream.webp",
    title: "Upstream"
  },
  fez: {
    type: "game",
    url: "/static/games/html/fez.html",
    icon: "/static/icons/fez.webp",
    title: "Fez"
  },
  vampireSurvivors: {
    type: "game",
  ...
  bendy: {
    type: "game",
    url: "https://selenite.cc/resources/semag/bendy/index.html",
    icon: "/static/icons/bendy.webp",
    title: "Bendy"
  },
  gtaVc: {
    type: "game",
  ...
  kindergarten3: {
    type: "game",
    url: "/static/games/kindergarten3/index.html",
    icon: "/static/icons/kind3.webp",
  ...
  breakTheWorm: {
    type: "game",
    url: "/static/flashpointarchive.html?fpGameName=breakTheWorm",
    icon: "/static/icons/breakTheWorm.webp",
    title: "Break The Worm"
  },
  finnAndBones: {
    type: "game",
  ...
  trinitas: {
    type: "game",
    url: "/static/games/trinitas/index.html",
    icon: "/static/icons/trinitas.webp",
    title: "Trinitas"
  },
  newyorkShark: {
    type: "swf",
  ...
  candyCrush: {
    type: "game",
    url: "/static/games/candyCrush/candy.html",
    icon: "/static/icons/candy.webp",
    title: "Candy Crush"
  },
  oneshot: {
    type: "game",
  ...
  gunMayhem: {
    type: "swf",
    swf: "/static/games/swfGames/gunmayhem.swf",
    icon: "/static/icons/gun.webp",
    title: "Gun Mayhem"
  },
  gunMayhem2: {
    type: "swf",
    swf: "/static/games/swfGames/gunmayhem2.swf",
    icon: "/static/icons/gun2.webp",
    title: "Gun Mayhem 2"
  },
  dadnme: {
    type: "swf",
    swf: "/static/games/swfGames/dadnme.swf",
  ...
  effingWorms: {
    type: "swf",
    swf: "https://cache.armorgames.com/files/games/effing-worms-1-13569.swf?v=1373587527",
    icon: "/static/icons/effing1.webp",
    title: "Effing Worms"
  },
  effingWorms2: {
    type: "swf",
    swf: "https://cache.armorgames.com/files/games/effing-worms-2-x-13668.swf?v=1373587527",
