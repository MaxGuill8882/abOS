  ...
  return `
    <div id="pane-autostart" class="settings-category-pane">
      ...
      <div class="settings-card">
        ...
        <p class="autostart-intro">Choose which system apps open automatically when abOS starts.</p>
...
export function renderDataSettings() {
  return `
    <div id="pane-data" class="settings-category-pane">
      ...
      <div class="settings-card" style="margin-top: 16px;">
        <div class="settings-card-header"><i class="fas fa-download"></i> Save abOS</div>
        <div class="settings-row">
          <div class="settings-label-group">
            <span class="settings-label-title">Download Page</span>
            <span class="settings-label-desc">Save a local copy of abOS</span>
          </div>
    ...
    <div class="settings-card settings-licenses-card">
      ...
      <div class="settings-credits-author">
        ...
        <div class="settings-credits-author-info">
          ...
          <span class="settings-credits-author-sub">Creator of abOS</span>
        </div>
      ...
      <div class="settings-card">
        ...
        <div class="settings-row" style="flex-direction: column; align-items: flex-start; gap: 12px; padding: 20px;">
          <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div>
              <h2 style="margin:0;font-size:1.3em;font-weight:600;display:flex;align-items:center;gap:8px;color:var(--text-primary);">abOS <span style="font-size:0.65em;background:var(--brand-dim);color:var(--brand);padding:2px 8px;border-radius:4px;font-weight:500;">${YUKIOS_VERSION}</span></h2>
